...
<table class="table">
    ...
    <tr style="clear: left">
        <td class="booksImageContainer">
            ...
            <br /><strong>Springer Verlag 2012</strong>
        </td>
        <td>
            <h3>A book aimed to physical therapists.</h3>
            <h4>Foreword by Gwendolin Jull.</h4>
    ...
    <tr>
        <td colspan="2">
            <h3>Proceedings of the Symposia of the EU Project “Prevention of muscle disorders in the operation of computer input devices (PROCID)”, 1999 and 2001.</h3>
    ...
    <tr>
        ...
        <td>
            <h3>Italian translation of the “European Recommendations for Surface Electromyography”, Edizioni Coop. Libraria Universitaria. Torino (CLUT), Italy, 2000.</h3>
        </td>
    </tr>
    <tr>
        <td>
